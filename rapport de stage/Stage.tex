...
\item Une \textbf{\textit{puissance dynamique}} de haute valeur, qui apparait lors d'une commutation. Elle dépend du type de transition. Elle n'est \textbf{pas négligée}.
\end{itemize}
...
\includepdf[pagecommand=\section{Traces}, angle=90]{image/traces.pdf}\label{ann:Traces}
%\caption{Les 4 premières traces mesurées à l'oscilloscope.}

\includepdf[pagecommand=\section{Corrélation pour les clés 1 à 4}, angle=90]{image/cle.pdf}\label{ann:corrélation}
%     \caption{Les valeurs de coefficient de corrélation obtenues pour les valeurs de clé : 128, 129, 130 et 131 respectivement.}

\includepdf[pagecommand=\section{Corrélations 3D}, angle=90]{image/correlation3D.pdf}\label{ann:Corrélations_3D}
%     \caption{Affichage en 3D de toutes les valeurs de corrélation obtenues pour chaque valeur de clé possible.}

\includepdf[pagecommand=\section{Corrélation pour la clé 8}, angle=90]{image/cle8.pdf}\label{ann:cle8}
